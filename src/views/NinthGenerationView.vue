...
export default {
    ...
    async mounted() {
        ...
        if (pkmnStore.listOfPokemonByGeneration[9].length === 0) {
            await pkmnStore.getPokemonByGeneration(9)
        }
        this.listOfPokemon = pkmnStore.listOfPokemonByGeneration[9]
